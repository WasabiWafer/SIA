...
namespace sia
{
    ...
    template <size_t Size>
    using signed_interger_t   = std::make_signed_t  <decltype(types_detail::get_integer_type<Size>())>;
    template <size_t Size>
    using unsigned_interger_t = std::make_unsigned_t<decltype(types_detail::get_integer_type<Size>())>;
    template <size_t Size>
    using floating_point_t    = decltype(types_detail::get_floating_type<Size>());
} // namespace sia
